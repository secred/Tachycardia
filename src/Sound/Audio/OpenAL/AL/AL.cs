...
namespace OpenTK.Audio.OpenAL
{
    ...
    public static partial class AL
    {
        ...
        */
        ...
        public static void Listener(ALListener3f param, ref Mogre.Vector3 values)
        {
        ...
        public static void Listener(ALListenerfv param, ref Mogre.Vector3 at, ref Mogre.Vector3 up)
        {
        ...
        public static void GetListener(ALListener3f param, out Mogre.Vector3 values)
        {
        ...
        /// <param name="at">A Math.Vector3 for the At-Vector.</param>
        /// <param name="up">A Math.Vector3 for the Up-Vector.</param>
        public static void GetListener(ALListenerfv param, out Mogre.Vector3 at, out Mogre.Vector3 up)
        {
        ...
        [CLSCompliant(false)]
        public static void Source(uint sid, ALSource3f param, ref Mogre.Vector3 values)
        {
        ...
        /// <param name="param">The name of the attribute to set: ALSource3f.Position, Velocity, Direction.</param>
        /// <param name="values">A Math.Vector3 which the attribute will be set to.</param>
        public static void Source(int sid, ALSource3f param, ref Mogre.Vector3 values)
        {
        ...
        [CLSCompliant(false)]
        public static void GetSource(uint sid, ALSource3f param, out Mogre.Vector3 values)
        {
        ...
        /// <param name="param">the name of the attribute being retrieved: ALSource3f.Position, Velocity, Direction.</param>
        /// <param name="values">A Math.Vector3 to retrieve the values to.</param>
        public static void GetSource(int sid, ALSource3f param, out Mogre.Vector3 values)
        {
