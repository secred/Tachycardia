...
namespace OpenTK.Audio.OpenAL
{
    ...
    public partial class EffectsExtension
    {
        ...
        [CLSCompliant(false)]
        public void Effect(uint eid, EfxEffect3f param, ref Mogre.Vector3 values)
        {
            unsafe
            {
        ...
        public void Effect(int eid, EfxEffect3f param, ref Mogre.Vector3 values)
        {
        ...
        public void GetEffect(int eid, EfxEffect3f param, out Mogre.Vector3 values)
        {
